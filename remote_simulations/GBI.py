...
def run_GBI_sim(dict_params, path):
    ...
    poly_sim = Poly_simulationGBI(dict_params=dict_params, save_path=folder_path)
...
run_GBI_sim(dict_params=dict_params, path=path)