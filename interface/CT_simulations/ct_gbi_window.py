...
class CTGBIWindow(ctk.CTk):

    def __init__(self, controller):
        super().__init__()
        self.controller = controller
        self.protocol("WM_DELETE_WINDOW", self.on_close)
        self.title("CT GBI Options")
    ...
    def setup_tab2(self):
        ...
        # Run button
        run_button = ctk.CTkButton(btn_run_frame, text="Run CT GBI Simulation", command=self.run_CT_GBI_sim)
        run_button.pack(side="left", padx= 10, pady=(0, 10))

        # Run button
        run2_button = ctk.CTkButton(btn_run_frame, text="Run CT GBI Simulation on Server", command=self.run_CT_GBI_sim_server)
    ...
    def run_CT_GBI_sim(self):
        run_CT_GBI_sim(self)

    def run_CT_GBI_sim_server(self):
        self.define_param_dict()
        ...
        self.destroy()
        self.controller.ext_script = "ct_GBI.py"
