...
class CTInlineWindow(ctk.CTk):

    def __init__(self, controller):
        super().__init__()
        self.controller = controller
        self.protocol("WM_DELETE_WINDOW", self.on_close)
        self.title("CT Inline Options")
    ...
    def setup_tab1(self):
        ...
        for frame in [self.source_frame, self.det_frame, self.samp_frame, self.geom_frame, self.ct_frame]:
            for c in range(6):
    ...
    def run_Inline_sim_server(self):
        ...
        self.destroy()
        self.controller.ext_script = "ct_inline.py"
