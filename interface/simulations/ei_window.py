...
class EIWindow(ctk.CTk):

    def __init__(self, controller):
        super().__init__()
        self.controller = controller
        self.protocol("WM_DELETE_WINDOW", self.on_close)
        self.title("EI Options")
    ...
    def setup_tab1(self):
        ...
        # Show alignment button (right of Save)
        showalg_btn = ctk.CTkButton(btn_frame, text="Show Alignment", command=self.show_alignment)
    ...
    def setup_tab2(self):
        ...
        # Run button
        run_button = ctk.CTkButton(btn_run_frame, text="Run EI Simulation", command=self.run_EI_sim)
        run_button.pack(side="left", padx= 10, pady=(0, 10))

        # Run button
        run2_button = ctk.CTkButton(btn_run_frame, text="Run EI Simulation on Server", command=self.run_EI_sim_server)
        run2_button.pack(side="left", padx= 10, pady=(0, 10))

        # Run button
        retrieve_button = ctk.CTkButton(btn_run_frame, text="EI Retrieval", command=self.go_to_retrieval)
        retrieve_button.pack(side="left", padx= 10, pady=(0, 10))
    ...
    def show_setup(self):
        ...
        fig = self.plots.plot_setup_ei(dict_params=self.dict_params)
    ...
    def run_EI_sim_server(self):
        ...
        self.destroy()
        self.controller.ext_script = "ei.py"
        self.controller.show_ei_window_server()

    def run_ext_sim(self):
        run_ext_sim_general(self)

    def go_to_retrieval(self):
        self.controller.flag_sim_to_ret = True
